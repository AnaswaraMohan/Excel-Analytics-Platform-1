...
const Login = ({ onSuccess, onSwitchModal }) => {
      ...
      <form onSubmit={onSubmit} className="space-y-6">
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-white/50">
            ...
            <button type="button" onClick={onSwitchModal} className="font-medium text-pigmentgreen-400 hover:text-pigmentgreen-300">Sign Up</button>
          </p>
        </div>
      </form>
    </>
