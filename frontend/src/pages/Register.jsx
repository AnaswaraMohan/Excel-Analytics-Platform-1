  ...
  const toggleConfirmPasswordVisibility = () => {
    ...
    >      {/* OAuth Buttons */}
      <div className="grid grid-cols-2 gap-3 mb-6">
        <button
          type="button"
          className="flex items-center justify-center px-4 py-3 border border-malachite-300 rounded-lg shadow-sm bg-white text-sm font-medium text-blackolive-500 hover:bg-malachite-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-malachite-500 transition-colors duration-200"
        >
      ...
      <form onSubmit={onSubmit} className="space-y-4">        {/* Full Name */}
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg text-sm font-medium text-white bg-pigmentgreen-500 hover:bg-malachite-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-malachite-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 mt-6"
        >
          {isLoading ? (
            <>
